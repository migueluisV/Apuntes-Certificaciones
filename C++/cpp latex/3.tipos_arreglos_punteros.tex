...
Una buena practica es crear punteros e inicializarlos a valor \textit{null}, utilizar la instrucción \textit{delete} después de utilizarlos (con o sin el uso de memoria dinámica) y volver a asignarles un valor \textit{null}.
