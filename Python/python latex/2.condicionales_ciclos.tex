...
\begin{lstlisting}
	...
	if (x == 0): # Primer condicion.
		...
		print("Mayor a 10")
	else: #S i no se cumplio ninguna condicion.
		print("Numero no valido")
\end{lstlisting}
...
\hspace{0.55cm}Ciclo que se repite una cantidad fija de veces, se utiliza para recorrer listas o cadena de texto, se pueden utilizar las instrucciones \textbf{break} y \textbf{continue} para salir o saltar en el ciclo, como con el ciclo while. Sintaxis:
\begin{lstlisting}
