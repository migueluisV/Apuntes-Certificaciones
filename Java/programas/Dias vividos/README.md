...
El programa solamente tiene un procedimiento estático adicional, el cual recibe, en una variable entera, una cantidad de años transcurridos, para luego pasarlo a una cantidad de días transcurridos dentro de dichos añós, y lo despliega.