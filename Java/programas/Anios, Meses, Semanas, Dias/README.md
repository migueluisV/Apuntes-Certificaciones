...
El programa tiene una clase llamada `DiasYMeses`, la cual tiene atributos privados y tres procedimientos, uno que es llamado cuando comienza la ejecución del programa, el cual da comienzo a la entrada de un número entero que representa un número de días transcurridos, un método que calcula cuantas semanas, años y meses han transcurrido en dicha cantidad de días, y un método que despliega dicha información.