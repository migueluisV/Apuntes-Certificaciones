...
El programa posee un procedimiento estático que pregunta por un número entero, determina si es un número par o impar por medio del operador módulo (%) y lo despliega.