...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{m{4cm}|m{8cm}}
            ...
            Float		& Representa un número decimal, tiene un espacio limitado al tipo de dato, p. e: b = 3.14 \\
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{l|l}
            ...
            \textbf{*, **, /, //, \%}	& Multiplicación, potenciación, división decimal, división entera y módulo \\
            \textbf{+, -}				& Suma y resta \\
            \hline
        \end{tabular}
    \end{center}
...
\begin{itemize}
	...
	\item La potenciación es la operación donde dos asteriscos eleva el número x a la potencia y. La potenciación puede concatenarse con otras potenciaciones (2**3**2). Puede usarse floats en la potenciación también.
...
\subsection{Cadenas}
\hspace{0.55cm}Existe el carácter especial \textbf{\textbackslash}, llamado \textbf{secuencia de escape}, este te permite imprimir o llevar a cabo ciertas acciones dentro de una cadena, como lo pueden ser:
\begin{itemize}
...
\begin{itemize}
	...
	\item Podemos buscar una subcadena o carácter dentro de una cadena con la sentencia \textbf{in} (misma sentencia para buscar un elemento dentro de una colección de datos): \textit{if subcadena in cadena}.
\end{itemize}
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{m{4cm}|m{4cm}|m{4cm}}
            ...
            \textbf{join(lista)}													& Pasa una lista a una cadena de texto, separado por un carácter (por ejemplo, un espacio)						& x = ", ".join([1, 3, 5, 7]) \\
            \textbf{split(carácter separador)}									& Separa una cadena utilizando un carácter separador (por ejemplo: separa la palabra "ámbar" donde las "a"s serán los separadores, obtenemos una lista de dos elementos, los cuales son "mb" y "r")																						& str = "esto es una cadena" print(str.slip(" ")) \\
            ...
            \textbf{find()}														& Busca un carácter o subcadena dentro de una cadena, si lo encuentra, regresa el índice del primer carácter donde lo encontró, si no lo encuentra, regresa -1																													& cadena.find("a") \\
            \hline
        \end{tabular}
    \end{center}    
\end{table}
