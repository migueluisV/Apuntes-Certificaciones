...
El objetivo de este programa es repasar el polimorfismo de una clase base en cuatro clases derivadas, el único cambio es que, en la clase base, existe un método que será sobre escrito por las demás clases derivadas, adecuandose al comportamiento de cada una.