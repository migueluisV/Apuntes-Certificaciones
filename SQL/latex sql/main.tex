...
\include{2.filtrando_datos}
\include{3.agregado_grupos}
\include{4.operaciones_de_tablas}
\include{5.manipulacion_datos}
\include{6.restricciones_de_tablas}
\include{7.trabajando_con_datos}
